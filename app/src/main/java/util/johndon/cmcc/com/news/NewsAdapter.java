...
public class NewsAdapter extends BaseAdapter<News> {
    ...
    public NewsAdapter(Context context, int layoutId, List<News> datas,LinkClickListener listener) {
    ...
    public void convert(ViewHolder holder, final News news) {
        ...
        holder.setText(R.id.tv_category_date,news.getCategory()+"  "+news.getDate());
